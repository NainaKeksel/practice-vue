...
Vue.component('product-review', {
    template: `
        <form class="review-form" @submit.prevent="onSubmit">
            ...
            <p>
                <label class="rec">Смогли бы вы порекомендовать этот товар?</label>
...
Vue.component('product-tabs', {
            ...
            <div v-show="selectedTab === 'Оставить отзыв'">
                <div class="modal" :class="{ open: isModalOpen }">
                    <div class="modal-content">
                        ...
                        <product-review @close-modal="closeModal"></product-review>
                    </div>
                </div>
            </div>
    ...
    methods: {
        selectTab(tab) {
            ...
            if (tab === 'Оставить отзыв') {
                this.isModalOpen = true;
            }
        },
        closeModal() {
            this.isModalOpen = false;
            this.selectedTab = 'Отзывы'; // Возвращаемся на вкладку "Отзывы"
        }
    }
})
